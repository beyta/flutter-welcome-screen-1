...
import 'package:flutterwelcome/constants/byxcolors.dart';

ThemeData byAppTheme = ThemeData(
  primaryColor: byPrimaryColor,
  highlightColor: byHighlightColor,
  ...
  fontFamily: 'PlayFair',
    ...
    textTheme: TextTheme(
      ...
      headline3: TextStyle(color: byPrimaryColor, fontWeight: FontWeight.bold, fontSize: 20 ),
